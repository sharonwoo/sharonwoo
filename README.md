...
🌱 [homelab](https://github.com/serversandbox) running Proxmox/k3s with Immich, Jellyfin, Adguard Home, Syncthing 
, Prometheus/Grafana exposed through Tailscale Operator; all SSD NAS running TrueNAS Scale Fangtooth
